...
const MoreResourcesView = () => {
    ...
    <div style={{padding:'100px 100px 100px 100px'}}>
        ...
        <p>  Complete the  <a href="https://sjsu.qualtrics.com/jfe/form/SV_3jDkvbK7IA0xeWG" style={{ color: 'blue', textDecoration: 'underline' }}> Spartan Food Pantry Intake & Agreement Form</a>.
            Once approved, create an account in PantrySoft via link found in your confirmation email. This must be completed before the first visit of each academic year.
        ...
        <p>
            ...
            Quantity limits on items are based on availability and demand to ensure all students get an opportunity to select.
        </p>
        ...
        <ul>
            <li>
                <a href="https://cm.maxient.com/reportingform.php?SanJoseStateUniv&layout_id=12" style={{ color: 'blue', textDecoration: 'underline' }}>
